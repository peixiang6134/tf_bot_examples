...
from dependency.tf_models.models.official.utils.logs import cloud_lib
...
def config_benchmark_logger(flag_obj=None):
  ...
  try:
    ...
    if (not hasattr(flag_obj, "benchmark_logger_type") or
      ...
      from dependency.tf_models.models.official.benchmark import benchmark_uploader as bu  # pylint: disable=g-import-not-at-top
